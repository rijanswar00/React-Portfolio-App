        ...
        <section id="projects" className="py-24 px-4 relative">
            <div className="container mx-auto max-w-5xl">
                            ...
                            <div className="p-6">
                                <div className="flex flex-wrap gap-2 mb-4">
                                    {project.tags.map((tag, key) => (
                                        <span className="px-2 py-1 border text-xs font-medium rounded-full bg-primary/20 text-secondary-foreground" key={key}>{tag} </span>
                                    ))}
                                </div>
                ...
                <div className="text-center mt-12">
                    <a target="_blank" href="https://github.com/rijanswar00" className="cosmic-button w-fit flex items-center mx-auto gap-2">
